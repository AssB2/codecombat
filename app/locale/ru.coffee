...
#    tip_adding_orgres: "Rounding up ogres."
    ...
    tip_ratatouille: "Вы не должны давать кому-либо определять ваши границы из-за вашего происхождения.Единственное ваше ограничение - это ваша душа. - Gusteau, Ratatouille"
...
#    tip_nerds: "Nerds are allowed to love stuff, like jump-up-and-down-in-the-chair-can't-control-yourself love it. - John Green"
    tip_self_taught: "Я выучил сам 90% того, что знаю. И это нормально! - Hank Green"
#    tip_luna_lovegood: "Don't worry, you're just as sane as I am. - Luna Lovegood"
    tip_good_idea: "Лучший метод получить хорошую идею - иметь много идей. - Linus Pauling"
    tip_programming_not_about_computers: "Компьютерная наука изучает компьютеры не больше, чем астрономия - телескопы. - Edsger Dijkstra"
    tip_mulan: "Поверьте в то, что вы можете, и тогда вы сможете. - Mulan"
...
#    elliot_title: "Partnership Manager"
    ...
    community_subtitle: "Более 450 участников помогли сделать CodeCombat, и новые присоединяются каждую неделю!"
...
#    jobs_subtitle: "Don't see a good fit but interested in keeping in touch? See our \"Create Your Own\" listing."
    jobs_benefits: "Выгоды сотрудников"
...
#    learn_more: "Learn More"
    jobs_custom_title: "Создайте ваш собственный"
...
#    subtitle: "Get your students started in less than an hour. You'll be able to <strong>create a class, add students, and monitor their progress</strong> as they learn computer science."
    email_exists: "Существует пользователь с таким email."
...
#    num_students_default: "Select Range"
    education_level_label: "Уровень образования обучающихся"
#    education_level_help: "Choose as many as apply."
    elementary_school: "Начальная школа"
    high_school: "Высшая школа"
    please_explain: "(пожалуйста объясните)"
    middle_school: "Средняя школа"
    college_plus: "Колледж или высше"
    anything_else: "Что-нибудь еще, что мы должны знать?"
...
#    teacher_dashboard: "Teacher Dashboard" # Navbar
    my_classes: "Мои классы"
    courses: "Курсы"
    enrollments: "ОбЪединения обучающихся"
    resources: "Ресурсы"
    help: "Помощь"
    students: "Обучаюбщиеся" # Shared
    language: "Язык"
    edit_class_settings: "изменить настройки класса"
    complete: "Завершено"
    access_restricted: "Необходимо обновление аккаунта"
    teacher_account_required: "Для доступа к этому контенту необходим аккаунт учителя."
    create_teacher_account: "Создать аккаунт учителя"
    what_is_a_teacher_account: "Что такое аккаунт учителя?"
    teacher_account_explanation: "Аккаунт учителя в CodeCombat позволяет вам создавать классы, отслеживать прогресс обучающихся по мере того, как они проходят курсы, управлять объединениями обучающихся и получать доступ к помощи в вашем учебном плане."
...
#    no_students_yet: "This class has no students yet."
    add_students: "Добавить обучающихся"
    create_new_class: "Создать новый класс"
#    class_overview: "Class Overview" # View Class page
#    avg_playtime: "Average level playtime"
#    total_playtime: "Total play time"
    avg_completed: "В среднем завершенных уровней"
    total_completed: "Всего завершенных уровней"
#    created: "Created"
